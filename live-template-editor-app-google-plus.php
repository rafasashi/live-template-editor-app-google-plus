<?php
/*
 * Plugin Name: Live Template Editor App Google Plus
 * Version: 1.0
 ...
 */
	...
	*/
	...
	/**
	 * Returns the main instance of LTPLE_App_Google_Plus to prevent the need to use globals.
	 *
	 * @since  1.0.0
	 * @return object LTPLE_App_Google_Plus
	 */
	function LTPLE_App_Google_Plus ( $version = '1.0.0' ) {
		
		$instance = LTPLE_Client::instance( __FILE__, $version );
		
		if ( empty( $instance->App_Google_Plus ) ) {
			
			$instance->App_Google_Plus = new stdClass();
			
			$instance->App_Google_Plus = LTPLE_App_Google_Plus::instance( __FILE__, $instance, $version );
		}
	...
	add_filter( 'plugins_loaded', function(){
		...
		if( $mode == '-dev' ){
			...
			LTPLE_App_Google_Plus('1.1.1');
		}
		else{
			
			LTPLE_App_Google_Plus('1.1.0');
		}		
	});