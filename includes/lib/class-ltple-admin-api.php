...
class LTPLE_App_Google_Plus_Admin_API {
	...
	public function display_field ( $data = array(), $item = false, $echo = true ) {
		...
		switch( $field['type'] ) {
			...
			case 'image':
				...
				$html .= '<input id="' . $option_name . '_button" type="button" data-uploader_title="' . __( 'Upload an image' , 'live-template-editor-app-google-plus' ) . '" data-uploader_button_text="' . __( 'Use image' , 'live-template-editor-app-google-plus' ) . '" class="image_upload_button button" value="'. __( 'Upload new image' , 'live-template-editor-app-google-plus' ) . '" />' . "\n";
				$html .= '<input id="' . $option_name . '_delete" type="button" class="image_delete_button button" value="'. __( 'Remove image' , 'live-template-editor-app-google-plus' ) . '" />' . "\n";
