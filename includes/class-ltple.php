...
class LTPLE_App_Google_Plus {
	...
	public function __construct ( $file='', $parent, $version = '1.0.0' ) {
		...
		$this->settings = new LTPLE_App_Google_Plus_Settings( $this->parent );
		
		$this->admin = new LTPLE_App_Google_Plus_Admin_API( $this );
		...
		$apps = $this->parent->apps->get_terms( 'app-type', array(
			...
			'google-plus' => array(
				...
				'options' 	=> array(
					...
					'thumbnail' => $this->assets_url . 'google-plus.png',
	...
	/**
	 * Main LTPLE_App_Google_Plus Instance
	 *
	 * Ensures only one instance of LTPLE_App_Google_Plus is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see LTPLE_App_Google_Plus()
	 * @return Main LTPLE_App_Google_Plus instance
	 */
